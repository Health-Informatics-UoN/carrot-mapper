...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-muted transition-colors hover:bg-accent data-[state=selected]:bg-accent",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left font-medium text-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
